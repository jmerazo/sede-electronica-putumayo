...
class ContractorController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('publication.contractors', compact('contractors'));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('publication.contractors', compact('contractor'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.contractors.index')->with('success', 'Contratista creado con éxito');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.contractors.index')->with('success', 'Contratista actualizado con éxito');
    }
