...
@section('content')
<div class="container">
    <h1>Solicitud de Pasaporte - Agendar Cita</h1>
...
<script>
// Días festivos pasados desde el controlador
var holidays = @json($holidays); // Días festivos obtenidos desde la API
console.log('Días festivos:', holidays);

// Función para verificar si una fecha es festivo en Colombia
function isHoliday(date) {
    const dateString = date.toISOString().split('T')[0];
    return holidays.includes(dateString); // Verifica si la fecha está en la lista de festivos
}
...
// Modificar FullCalendar para deshabilitar los días festivos y fines de semana
